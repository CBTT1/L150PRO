...
void PS2_Read(void)
{
  ...
  //读取右边遥感Y轴方向的模拟量  
	...
	{
		PS2_ON_Flag=RC_ON;APP_ON_Flag=RC_OFF;
		PS2_Velocity = Default_Velocity;
		if(Car_Mode == Akm_Car)//如果是阿克曼车，转向速度是角度
		{
			PS2_Turn_Velocity = PS2_Turn_Angle;
		}
		else			//其他车型是两轮差速
			PS2_Turn_Velocity = Default_Turn_Bias;
  }
}
/**************************************************************************
